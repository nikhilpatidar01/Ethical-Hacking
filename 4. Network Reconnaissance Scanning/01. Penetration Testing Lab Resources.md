...
| **bWAPP (bee-box v1.6)** | Comprehensive web app security training platform — includes XSS, SQLi, CSRF, etc.                  | [bWAPP bee-box(Vulnbub)](https://www.vulnhub.com/entry/bwapp-bee-box-v16,53/)                   |
